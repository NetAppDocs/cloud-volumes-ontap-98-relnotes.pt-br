...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-getting-started-aws-c2s.html#limitations["Exibir limitações para o Cloud Volumes ONTAP no AWS C2S"^].
